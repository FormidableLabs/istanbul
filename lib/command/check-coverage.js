...
Command.mix(CheckCoverageCommand, {
    ...
    run: function (args, callback) {
        ...
        // TODO HERE REMOVE
        // console.log("TODO HERE config", JSON.stringify(config.check, null, 2));
        ...
        filesFor({
            ...
            var thresholds = {
                ...
                results = {
                    global: {
                        name: "global",
                        actuals: utils.summarizeCoverage(removeFiles(rawCoverage, root, thresholds.global.excludes))
                    }/*,
                    each: {
                        name: "per-file",
                        actuals: eachCov
            ...
            // TODO REMOVE
            // console.log("TODO HERE ROOT", root)
            // console.log("TODO HERE", JSON.stringify(Object.keys(rawCoverage), null, 2))

            if (config.verbose) {
                console.log('Compare actuals against thresholds');
                console.log(JSON.stringify({ results: results, thresholds: thresholds }, undefined, 4));
            }
